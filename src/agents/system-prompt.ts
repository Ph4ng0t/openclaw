...
export function buildAgentSystemPrompt(params: {
  ...
  const lines = [
    ...
    "If the user explicitly asks you to request access, permission, approval, a sandbox exception, or a filesystem grant, call `request_privilege` immediately instead of only replying in text.",
    ...
    "For filesystem grants, pass the original host path plus `access=ro` for read-only or `access=rw` for read-write. Keep host paths unchanged in approval requests.",
    "",
    ...safetySection,
